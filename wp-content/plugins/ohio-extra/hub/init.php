...
function ohio_hub_license_notice() {
    ...
    <div class="notice notice-error is-dismissible">
        <p>
            <svg style="vertical-align: middle; margin: -2px 2px 0 0;" fill="#d63638" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1 6h2v8h-2v-8zm1 12.25c-.69 0-1.25-.56-1.25-1.25s.56-1.25 1.25-1.25 1.25.56 1.25 1.25-.56 1.25-1.25 1.25z"/></svg> <b><?php _e( 'Theme activation is required.', 'ohio-extra' ); ?></b> <?php _e( 'Please, activate your license to be able to install the demo content and use all the built-in features.', 'ohio-extra' ); ?> <a href="admin.php?page=ohio_hub">Activate</a>
        </p>
    </div>
    <?php endif;
}
