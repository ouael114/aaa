...
function ohio_recent_projects_func( $atts ) {
	...
	if ( $overlay_color == 'brand' ) {
		$overlay_css = NorExtraParser::VC_color_to_CSS( $overlay_color, 'background-color:{{color}};' );
	} else if ( $overlay_color ) {
		$overlay_css = 'background-color:' . $overlay_color . ';';
	}
	if ( $video_btn_color == 'brand' ) {

		$video_btn_color_css = NorExtraParser::VC_color_to_CSS( $video_btn_color, 'background-color:{{color}};' );
		$video_btn_color_css .= NorExtraParser::VC_color_to_CSS( $video_btn_color, 'border-color:{{color}};' );
	...
	if ( $description_overlay_color == 'brand' ) {
		$description_overlay_color_css = NorExtraParser::VC_color_to_CSS( $description_overlay_color, 'background-color:{{color}};' );
	...
	if( $background_color == 'brand' ) {
		$description_overlay_color_css = NorExtraParser::VC_color_to_CSS( $background_color, 'background-color:{{color}};' );
	} else if ( $background_color ) {
		$background_css = 'background-color:' . $background_color . ';';
	}
	if( $nav_btn_color == 'brand' ) {
		$description_overlay_color_css = NorExtraParser::VC_color_to_CSS( $nav_btn_color, 'color:{{color}};' );
